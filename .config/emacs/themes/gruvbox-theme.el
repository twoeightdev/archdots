...
(let* ((gruvbox-dark0_hard  "#1d2021")
  ...
  (custom-theme-set-faces
    ...
    `(org-drawer                        ((t (:foreground ,gruvbox-faded_orange))))
    ...
    `(org-block                         ((t (:background ,gruvbox-dark0_soft))))
    `(org-block-begin-line              ((t (:foreground ,gruvbox-neutral_purple))))
    `(org-block-end-line                ((t (:foreground ,gruvbox-neutral_purple))))
